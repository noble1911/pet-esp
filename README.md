...
- **Options → My pet → Choose character** offers six complete animated friends: Sprout, Cloud bunny, Pebble penguin, Peach kitten, Tiny dragon and Rosy pig. Arrows preview; Choose this character saves the appearance without changing name, progress or personality. Existing pets return to the original Sprout. See [characters](docs/five-characters-v1.md) and [Rosy pig](docs/pink-pig-v1.md).
...
- `art/pixel-v1/`: approved concept. `art/sprite-v3/`: original Sprout and room artwork. `art/characters-v1/`: six independent complete characters, 156 frames and source prompts. `art/playtime-v1/`: new sticker and decoration source atlases, compiled previews and prompts. Packing scripts live in `scripts/`.
