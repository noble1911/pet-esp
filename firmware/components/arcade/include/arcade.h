...
typedef struct {
    ...
    struct {float x,y,vx,vy,aim,bucket;unsigned balls,catches,hits,shot_ms;uint64_t live;bool flying;} pegs;
...
void arcade_peg_pos(unsigned peg,float *x,float *y);
bool arcade_peg_gold(unsigned peg);
