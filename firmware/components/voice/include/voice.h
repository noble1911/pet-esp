...
typedef enum { PET_EVENT_NONE, PET_EVENT_CUDDLE, PET_EVENT_APPLE, PET_EVENT_TOAST,
    ...
    PET_EVENT_BATH, PET_EVENT_NAP, PET_EVENT_HIDE, PET_EVENT_BALL, PET_EVENT_BUTTERFLY, PET_EVENT_CUPCAKE, PET_EVENT_PANCAKES, PET_EVENT_JELLY, PET_EVENT_CAKE } pet_event_t;
