...
void audio_init(void)
{
    ...
    s_pcm=xStreamBufferCreate(96*1024,1);s_fx=xQueueCreate(4,sizeof(sfx_id_t));
    if(!s_pcm || !s_fx) return;
    xTaskCreatePinnedToCore(play_task,"pet_audio",4096,NULL,6,NULL,1);
    xTaskCreatePinnedToCore(mic_task,"pet_mic",4096,NULL,5,NULL,1);
}
